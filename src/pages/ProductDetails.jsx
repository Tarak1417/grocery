                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                               ...
                               <img src={i < 4 ? assets.star_icon : assets.star_dull_icon} alt="start rating" className="md:w-4 w-3.5"/>
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button  onClick={()=>{addToCart(product._id); navigate("/cart")}} className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-primarytransition" >
                            Buy now
                        </button>
                    </div>
                </div>
