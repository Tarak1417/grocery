  ...
  return (
    <div className='relative'>
     ...
     <div className=' flex item-center mt-6 font-medium'>
        <Link to={"/products"} className='group flex item center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull transition rounded text-white cursor-pointed'>Shop now
